\documentclass[
    ...
    \section{What can go Wrong?}
        ...
        our increasingly connected world. Interestingly enough the attitude I've encountered 
        ...
        \subsection{Recent Prolific Breaches Caused By Software Design}
            A number of recent breaches can be used as good examples of why this topic is highly 
            important:
            \begin{itemize}
                \item Equifax Breach 2017 (Estimated 143M individuals records leaked)\cite{EquifaxFTC}
                Caused by CVE-2017-5638\cite{CVE-2017-5638} Python \hyperref[sec:PythonApacheStruts]{\color{blue}POC}\cite{struts-pwn}
                ...
                \item Uber Breach 2016 (57M Users and 600,000 Drivers Data Exposed)\cite{}
                \item Ashley Maddison - 
                \item LinkedIn
                \item Jailbreaks
                \item Switch/IoS browser exploit 
            \end{itemize}
...
@ (?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?
  |  \[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}
    ...
    \section{Appendix}
        ...
        \label{sec:PythonApacheStruts}
            \pythonexternal{Resources/struts-pwn/struts-pwn.py}
