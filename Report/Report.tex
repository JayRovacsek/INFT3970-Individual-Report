\documentclass{IEEEtran}
    ...
    \section{Common Issues in most Languages}
        ...
        \subsection{Improper Error Handling}
            ...
            greeted by an error page served by the instance of IIS hosting the application:
...
syntax to use near Donoghue
        ...
        \subsection{Insecure Configuration and Using }
            Revealing information about packages, language version and other data points suggested above can lead to detection of either insecure of out-of-date configurations 
